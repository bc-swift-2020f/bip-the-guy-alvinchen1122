...
//  UIViewAnimations
//
//  Created by Alvin Chen on 9/19/20.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func movePressed(_ sender: UIButton) {
        ...
        UIView.animate(withDuration: 0.5, animations: {self.imageView.center.x = centerX}, completion: nil)
        UIView.animate(withDuration: 0.5, animations: {self.alphaButton.center.x = centerX}, completion: nil)
        UIView.animate(withDuration: 0.5, animations: {self.pulseButton.center.x = centerX}, completion: nil)
        UIView.animate(withDuration: 0.5, animations: {self.colorChangeButton.center.x = centerX}, completion: nil)
   
        
//        UIView.animate(withDuration: 2.0, delay: 0.0, options: [.curveLinear, .repeat], animations: {self.imageView.center.x = centerX}, completion: nil)
...
//        UIView.animate(withDuration: 2.0, delay: 0.0, options: [.curveEaseOut, .autoreverse], animations: {self.pulseButton.center.x = centerX}, completion: nil)
//        UIView.animate(withDuration: 2.0, delay: 0.0, options: [.curveEaseInOut, .autoreverse], animations: {self.colorChangeButton.center.x = centerX}, completion: nil)
    }
